...
ggplot(complete, aes(x=WVU, y=KSU), group_by(Name)) + geom_point() + xlim(c(0,5))+ ylim(c(0,8)) +xlab("Tackles Against WVU") + ylab("Tackles Against KSU") + ggtitle("Solo Tackles Against Kansas State and West Virginia")
```
